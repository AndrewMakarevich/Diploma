...
const EditPictureTypeForm = ({ initialParams, isOpen, setIsOpen, pictureTypes, setPictureTypes }: IEditPictureTypeFormProps) => {
  ...
  }, [editedParams, editPictureType, initialParams, pictureTypes, setPictureTypes]);
  ...
  return (
    <div className={formStyles["form-wrapper"]}>
      ...
      <form className={formStyles["form"]}>
        ...
        <StandartButton disabled={editPictureTypeLoading} type="submit" onClick={onSubmit}>Submit changes</StandartButton>
        <StandartButton disabled={editPictureTypeLoading} type="button" onClick={onClearChanges}>Clear changes</StandartButton>
        <DeleteButton disabled={editPictureTypeLoading} type="button" onClick={onClose}>Close</DeleteButton>
      </form>
    </div>
  )
};
